...
export function PopoutButton({ projectId }: Props) {
  ...
  return (
    <button onClick={open} className="px-3 py-1.5 text-[14px] font-medium bg-surface border border-border rounded text-ink-2 hover:border-ink-5 inline-flex items-center gap-1.5">
